...
print "flashlight.quadrotor3d: Constructing sympy symbols..."
...
I_expr, I_expr_entries                   = sympyutils.construct_matrix_and_entries("I",(3,3),   real=True)
f_external_expr, f_external_expr_entries = sympyutils.construct_matrix_and_entries("f_e",(3,1), real=True)
...
x_current_expr, x_current_expr_entries = sympyutils.construct_matrix_and_entries("x_current", (num_x_dims,1), real=True)
x_next_expr,    x_next_expr_entries    = sympyutils.construct_matrix_and_entries("x_next",    (num_x_dims,1), real=True)
u_current_expr, u_current_expr_entries = sympyutils.construct_matrix_and_entries("u_current", (num_u_dims,1), real=True)
...
print "flashlight.quadrotor3d: Finished constructing sympy symbols (%.03f seconds)." % (sys_time_end - sys_time_begin)

def compute_manipulator_matrices_symbolic(x_expr,t_expr):

    print "flashlight.quadrotor3d: Computing manipulator matrices in symbolic form..."
    ...
    print "flashlight.quadrotor3d: Finished computing manipulator matrices in symbolic form..."
...
if build_sympy_modules:
    ...
    print "flashlight.quadrotor3d: Constructing sympy expressions..."
    sys_time_begin = time.time()
    ...
    sys_time_end = time.time()
    print "flashlight.quadrotor3d: Finished constructing sympy expressions (%.03f seconds)." % (sys_time_end - sys_time_begin)

    print "flashlight.quadrotor3d: Building sympy modules..."
    sys_time_begin = time.time()

    current_source_file_path = pathutils.get_current_source_file_path()

    sympyutils.build_module_autowrap( expr=H_expr, syms=const_and_x_syms, module_name="quadrotor3d_H", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=C_expr, syms=const_and_x_syms, module_name="quadrotor3d_C", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=G_expr, syms=const_and_x_syms, module_name="quadrotor3d_G", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=B_expr, syms=const_and_x_syms, module_name="quadrotor3d_B", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )

    sympyutils.build_module_autowrap( expr=x_dot_expr, syms=const_and_x_and_u_syms, module_name="quadrotor3d_x_dot", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=df_dx_expr, syms=const_and_x_and_u_syms, module_name="quadrotor3d_df_dx", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=df_du_expr, syms=const_and_x_and_u_syms, module_name="quadrotor3d_df_du", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )

    sympyutils.build_module_autowrap( expr=g_dynamics_ti_expr,           syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor3d_g_dynamics_ti",           tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=dgdynamicsti_dxcurrent_expr,  syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor3d_dgdynamicsti_dxcurrent",  tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=dgdynamicsti_dxnext_expr,     syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor3d_dgdynamicsti_dxnext",     tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=dgdynamicsti_ducurrent_expr,  syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor3d_dgdynamicsti_ducurrent",  tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=dgdynamicsti_ddtcurrent_expr, syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor3d_dgdynamicsti_ddtcurrent", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor3d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )

    sys_time_end = time.time()
    print "flashlight.quadrotor3d: Finished building sympy modules (%.03f seconds)." % (sys_time_end - sys_time_begin)

print "flashlight.quadrotor3d: Loading sympy modules..."
sys_time_begin = time.time()

current_source_file_path = pathutils.get_current_source_file_path()

H_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_H", path=current_source_file_path+"/data/quadrotor3d" )
C_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_C", path=current_source_file_path+"/data/quadrotor3d" )
G_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_G", path=current_source_file_path+"/data/quadrotor3d" )
B_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_B", path=current_source_file_path+"/data/quadrotor3d" )

x_dot_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_x_dot", path=current_source_file_path+"/data/quadrotor3d" )
df_dx_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_df_dx", path=current_source_file_path+"/data/quadrotor3d" )
df_du_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_df_du", path=current_source_file_path+"/data/quadrotor3d" )

g_dynamics_ti_autowrap           = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_g_dynamics_ti",           path=current_source_file_path+"/data/quadrotor3d" )
dgdynamicsti_dxcurrent_autowrap  = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_dgdynamicsti_dxcurrent",  path=current_source_file_path+"/data/quadrotor3d" )
dgdynamicsti_dxnext_autowrap     = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_dgdynamicsti_dxnext",     path=current_source_file_path+"/data/quadrotor3d" )
dgdynamicsti_ducurrent_autowrap  = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_dgdynamicsti_ducurrent",  path=current_source_file_path+"/data/quadrotor3d" )
dgdynamicsti_ddtcurrent_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_dgdynamicsti_ddtcurrent", path=current_source_file_path+"/data/quadrotor3d" )

H_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_H_vectorized", path=current_source_file_path+"/data/quadrotor3d" )
C_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_C_vectorized", path=current_source_file_path+"/data/quadrotor3d" )
G_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_G_vectorized", path=current_source_file_path+"/data/quadrotor3d" )
B_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_B_vectorized", path=current_source_file_path+"/data/quadrotor3d" )

x_dot_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_x_dot_vectorized", path=current_source_file_path+"/data/quadrotor3d" )
df_dx_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_df_dx_vectorized", path=current_source_file_path+"/data/quadrotor3d" )
df_du_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_df_du_vectorized", path=current_source_file_path+"/data/quadrotor3d" )

g_dynamics_ti_vectorized_autowrap           = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_g_dynamics_ti_vectorized",           path=current_source_file_path+"/data/quadrotor3d" )
dgdynamicsti_dxcurrent_vectorized_autowrap  = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_dgdynamicsti_dxcurrent_vectorized",  path=current_source_file_path+"/data/quadrotor3d" )
dgdynamicsti_dxnext_vectorized_autowrap     = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_dgdynamicsti_dxnext_vectorized",     path=current_source_file_path+"/data/quadrotor3d" )
dgdynamicsti_ducurrent_vectorized_autowrap  = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_dgdynamicsti_ducurrent_vectorized",  path=current_source_file_path+"/data/quadrotor3d" )
dgdynamicsti_ddtcurrent_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor3d_dgdynamicsti_ddtcurrent_vectorized", path=current_source_file_path+"/data/quadrotor3d" )

sys_time_end = time.time()
print "flashlight.quadrotor3d: Finished loading sympy modules (%.03f seconds)." % (sys_time_end - sys_time_begin)
...
def compute_state_space_trajectory_and_derivatives(p,psi,dt,check_angles=True):
    ...
    p_dotN    = gradientutils.gradients_vector_wrt_scalar_smooth_boundaries(p,dt,max_gradient=2,poly_deg=5)
    p_dot     = p_dotN[1]
    p_dot_dot = p_dotN[2]
    ...
    theta_dotN = gradientutils.gradients_scalar_wrt_scalar_smooth_boundaries(theta,dt,max_gradient=2,poly_deg=5)
    psi_dotN   = gradientutils.gradients_scalar_wrt_scalar_smooth_boundaries(psi,dt,max_gradient=2,poly_deg=5)
    phi_dotN   = gradientutils.gradients_scalar_wrt_scalar_smooth_boundaries(phi,dt,max_gradient=2,poly_deg=5)
...
def draw(x, q_q_dot_q_dot_dot_nominal=None, t=None):
    ...
    if q_q_dot_q_dot_dot_nominal is not None:
        ...
        # nominal trajectory
        pts = mayavi.mlab.quiver3d(p_nominal[:,2], p_nominal[:,1], p_nominal[:,0], ones(p_nominal.shape[0]), ones(p_nominal.shape[0]), ones(p_nominal.shape[0]), scalars=t, mode="sphere", scale_factor=s_trajectory)
