...
print "flashlight.quadrotor2d: Constructing sympy symbols..."
...
f_external_expr, f_external_expr_entries = sympyutils.construct_matrix_and_entries("f_external",(2,1), real=True)
...
u_expr, u_expr_entries = sympyutils.construct_matrix_and_entries("u",(num_u_dims,1), real=True)
...
print "flashlight.quadrotor2d: Finished constructing sympy symbols (%.03f seconds)." % (sys_time_end - sys_time_begin)



def compute_manipulator_matrices_symbolic(x_expr,t_expr):

    print "flashlight.quadrotor2d: Computing manipulator matrices in symbolic form..."
    ...
    print "flashlight.quadrotor2d: Finished computing manipulator matrices in symbolic form..."
...
if build_sympy_modules:
    ...
    print "flashlight.quadrotor2d: Constructing sympy expressions..."
    sys_time_begin = time.time()
    ...
    sys_time_end = time.time()
    print "flashlight.quadrotor2d: Finished constructing sympy expressions (%.03f seconds)." % (sys_time_end - sys_time_begin)

    print "flashlight.quadrotor2d: Building sympy modules..."
    sys_time_begin = time.time()

    current_source_file_path = pathutils.get_current_source_file_path()

    sympyutils.build_module_autowrap( expr=H_expr, syms=const_and_x_syms, module_name="quadrotor2d_H", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=C_expr, syms=const_and_x_syms, module_name="quadrotor2d_C", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=G_expr, syms=const_and_x_syms, module_name="quadrotor2d_G", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=B_expr, syms=const_and_x_syms, module_name="quadrotor2d_B", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )

    sympyutils.build_module_autowrap( expr=x_dot_expr, syms=const_and_x_and_u_syms, module_name="quadrotor2d_x_dot", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=df_dx_expr, syms=const_and_x_and_u_syms, module_name="quadrotor2d_df_dx", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=df_du_expr, syms=const_and_x_and_u_syms, module_name="quadrotor2d_df_du", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", dummify=True, build_vectorized=True, verbose=True, request_delete_tmp_dir=True )

    sympyutils.build_module_autowrap( expr=g_dynamics_ti_expr,           syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor2d_g_dynamics_ti",           tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=dgdynamicsti_dxcurrent_expr,  syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor2d_dgdynamicsti_dxcurrent",  tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=dgdynamicsti_dxnext_expr,     syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor2d_dgdynamicsti_dxnext",     tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=dgdynamicsti_ducurrent_expr,  syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor2d_dgdynamicsti_ducurrent",  tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )
    sympyutils.build_module_autowrap( expr=dgdynamicsti_ddtcurrent_expr, syms=const_and_xcurrent_and_xnext_and_ucurrent_and_dtcurrent_syms, module_name="quadrotor2d_dgdynamicsti_ddtcurrent", tmp_dir="tmp", out_dir=current_source_file_path+"/data/quadrotor2d", build_vectorized=True, verbose=True, request_delete_tmp_dir=True )

    sys_time_end = time.time()
    print "flashlight.quadrotor2d: Finished building sympy modules (%.03f seconds)." % (sys_time_end - sys_time_begin)

print "flashlight.quadrotor2d: Loading sympy modules..."
sys_time_begin = time.time()

current_source_file_path = pathutils.get_current_source_file_path()

H_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_H", path=current_source_file_path+"/data/quadrotor2d" )
C_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_C", path=current_source_file_path+"/data/quadrotor2d" )
G_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_G", path=current_source_file_path+"/data/quadrotor2d" )
B_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_B", path=current_source_file_path+"/data/quadrotor2d" )

x_dot_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_x_dot", path=current_source_file_path+"/data/quadrotor2d" )
df_dx_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_df_dx", path=current_source_file_path+"/data/quadrotor2d" )
df_du_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_df_du", path=current_source_file_path+"/data/quadrotor2d" )

g_dynamics_ti_autowrap           = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_g_dynamics_ti",           path=current_source_file_path+"/data/quadrotor2d" )
dgdynamicsti_dxcurrent_autowrap  = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_dgdynamicsti_dxcurrent",  path=current_source_file_path+"/data/quadrotor2d" )
dgdynamicsti_dxnext_autowrap     = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_dgdynamicsti_dxnext",     path=current_source_file_path+"/data/quadrotor2d" )
dgdynamicsti_ducurrent_autowrap  = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_dgdynamicsti_ducurrent",  path=current_source_file_path+"/data/quadrotor2d" )
dgdynamicsti_ddtcurrent_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_dgdynamicsti_ddtcurrent", path=current_source_file_path+"/data/quadrotor2d" )

H_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_H_vectorized", path=current_source_file_path+"/data/quadrotor2d" )
C_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_C_vectorized", path=current_source_file_path+"/data/quadrotor2d" )
G_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_G_vectorized", path=current_source_file_path+"/data/quadrotor2d" )
B_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_B_vectorized", path=current_source_file_path+"/data/quadrotor2d" )

x_dot_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_x_dot_vectorized", path=current_source_file_path+"/data/quadrotor2d" )
df_dx_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_df_dx_vectorized", path=current_source_file_path+"/data/quadrotor2d" )
df_du_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_df_du_vectorized", path=current_source_file_path+"/data/quadrotor2d" )

g_dynamics_ti_vectorized_autowrap           = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_g_dynamics_ti_vectorized",           path=current_source_file_path+"/data/quadrotor2d" )
dgdynamicsti_dxcurrent_vectorized_autowrap  = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_dgdynamicsti_dxcurrent_vectorized",  path=current_source_file_path+"/data/quadrotor2d" )
dgdynamicsti_dxnext_vectorized_autowrap     = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_dgdynamicsti_dxnext_vectorized",     path=current_source_file_path+"/data/quadrotor2d" )
dgdynamicsti_ducurrent_vectorized_autowrap  = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_dgdynamicsti_ducurrent_vectorized",  path=current_source_file_path+"/data/quadrotor2d" )
dgdynamicsti_ddtcurrent_vectorized_autowrap = sympyutils.import_anon_func_from_from_module_autowrap( module_name="quadrotor2d_dgdynamicsti_ddtcurrent_vectorized", path=current_source_file_path+"/data/quadrotor2d" )

sys_time_end = time.time()
print "flashlight.quadrotor2d: Finished loading sympy modules (%.03f seconds)." % (sys_time_end - sys_time_begin)
...
def draw(x, t_begin, dt, q_q_dot_q_dot_dot_nominal=None, t=None):
    ...
    if q_q_dot_q_dot_dot_nominal is not None:
        p_nominal, p_dot_nominal, p_dot_dot_nominal, theta_nominal, theta_dot_nominal, theta_dot_dot_nominal = q_q_dot_q_dot_dot_nominal
    ...
    if q_q_dot_q_dot_dot_nominal is not None:
        ax.scatter(p_nominal[:,1], p_nominal[:,0], c=t, cmap="jet", s=50, alpha=0.25)
    ...
    def animate(i):
        ...
        if q_q_dot_q_dot_dot_nominal is not None:
            p_nominal_y_current = [p_nominal[i,0]]
            p_nominal_x_current = [p_nominal[i,1]]
            p_nominal_plot.set_data(p_nominal_x_current, p_nominal_y_current)
        ...
        time_text.set_text(time_text_template % (t_begin+(i*dt)))
        debug_text.set_text("")
    ...
    animation = matplotlib.animation.FuncAnimation(fig, animate, arange(len(x)), interval=25, blit=True, init_func=init)
